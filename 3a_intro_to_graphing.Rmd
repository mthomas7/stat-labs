...
Create a histogram of one of the other variables in the cdc dataframe. Make sure to give it nicely labeled axes and a title.

Also, make a scatterplot of a different set of two variables.

Make side-by-side box and whisker plot of age by gender.
